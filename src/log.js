...
function printLog(content, type) {
    ...
    switch (type) {
        case LogLevelMap.tip: {
            ...
            console.log(chalk.cyan(`[AnyProxy 日志][${timeString}]: ` + content));
            break;
        }
        ...
        case LogLevelMap.system_error: {
            ...
            console.error(chalk.red(`[AnyProxy 错误][${timeString}]: ` + content));
            break;
        }
        ...
        case LogLevelMap.rule_error: {
            ...
            console.error(chalk.red(`[AnyProxy 规则错误][${timeString}]: ` + content));
            break;
        }
        ...
        case LogLevelMap.warn: {
            ...
            console.error(chalk.yellow(`[AnyProxy 警告][${timeString}]: ` + content));
            break;
        }
